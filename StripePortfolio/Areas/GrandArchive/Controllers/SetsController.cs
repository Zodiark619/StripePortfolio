...
namespace StripePortfolio.Areas.GrandArchive.Controllers
{
    ...
    public class SetsController : Controller
    {
        ...
        // GET: GrandArchive/Sets
        public async Task<IActionResult> Index()
        {
            return View(await _context.Set.ToListAsync());
        }

        // GET: GrandArchive/Sets/Details/5
        ...
        // GET: GrandArchive/Sets/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: GrandArchive/Sets/Create
        ...
        // GET: GrandArchive/Sets/Delete/5
        ...
        // POST: GrandArchive/Sets/Delete/5
